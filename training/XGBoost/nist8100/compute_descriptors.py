...
the NIST 8100 property datasets.

Produces: training/data/nist_8100/descriptors_rdkit_mordred.csv
...
CSV_FILES = [
    "density_cho_cleaned.csv",
    "viscosity_cho_cleaned.csv",
    "tc_cho_cleaned.csv",
    "cpsat_cho_cleaned.csv",
    "beta_cho_cleaned.csv",
    "fom1_cho_cleaned.csv",
]
