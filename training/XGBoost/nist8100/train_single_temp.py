#!/usr/bin/env python3
"""
Publication-quality XGBoost training pipeline for NIST 8100 single-temp models.
...
def main():
    parser = argparse.ArgumentParser(
        description="Train single-temp XGBoost models (Mordred + Optuna)",
    ...
    # Summary table
    print(f"\n{'=' * 80}")
    print("SINGLE-TEMP MODELS (5-fold nested CV, Mordred+RDKit, Optuna)")
    print(f"{'=' * 80}")
