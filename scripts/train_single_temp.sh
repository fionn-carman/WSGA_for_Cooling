...
# ============================================================
# XGBoost Single-Temp Training (Mordred + Optuna)
# ============================================================
#
...
#
# Usage:
#   qsub train_single_temp.sh          # all 6 in parallel
#   qsub -J 0-0 train_single_temp.sh   # single test (density)
# ============================================================
...
TRAIN_DIR="${PROJ_DIR}/training/XGBoost/nist8100"
...
exec > "$LOGFILE" 2>&1
echo "=== XGBoost single-temp training: ${PROP} ==="
