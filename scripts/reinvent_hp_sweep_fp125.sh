...
# ============================================================
# REINVENT HP Sweep — FP >= 125 C (398 K)
# ============================================================
#
...
#
# Usage:
#   qsub reinvent_hp_sweep_fp125.sh
#   qsub -J 0-0 reinvent_hp_sweep_fp125.sh        # single test job
#   bash reinvent_hp_sweep_fp125.sh <array_index>  # local test
# ============================================================
...
if [ -z "$N" ]; then
    if [ $# -eq 1 ]; then
        ...
        echo "Usage: bash reinvent_hp_sweep_fp125.sh <array_index>"
        exit 1
    fi
fi
...
# ==============================
output_dir="../outputs/reinvent_hp_sweep_fp125/lr${LR}_sigma${SIGMA}_bs${BATCH_SIZE}_replay${REPLAY}_seed${SEED}"
mkdir -p "$output_dir"

log_file="${output_dir}/config.log"
echo "========================================" > "$log_file"
echo "REINVENT HP Sweep (FP >= 125 C)"          >> "$log_file"
echo "========================================" >> "$log_file"
