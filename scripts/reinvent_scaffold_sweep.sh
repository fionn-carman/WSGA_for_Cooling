...
# ============================================================
# REINVENT Scaffold Diversity Sweep
# ============================================================
#
# Sweeps max_per_scaffold to quantify how scaffold diversity
# pressure affects REINVENT performance on cooling fluids.
# Analogous to the WSGA tau/niching sweep.
#
...
#
# Usage:
#   qsub reinvent_scaffold_sweep.sh
#   qsub -J 0-0 reinvent_scaffold_sweep.sh        # single test job
#   bash reinvent_scaffold_sweep.sh <array_index>  # local test
# ============================================================
...
if [ -z "$N" ]; then
    if [ $# -eq 1 ]; then
        ...
        echo "Usage: bash reinvent_scaffold_sweep.sh <array_index>"
        exit 1
    fi
fi
...
# Constraint thresholds (match WSGA tau sweep)
FP_THRESHOLD=373
MP_THRESHOLD=-30
BP_THRESHOLD=100
DC_THRESHOLD=7
...
# ==============================
output_dir="../outputs/reinvent_scaffold_sweep/mps${MPS_LABEL}_seed${SEED}"
mkdir -p "$output_dir"

log_file="${output_dir}/config.log"
echo "========================================" > "$log_file"
echo "REINVENT Scaffold Diversity Sweep"        >> "$log_file"
echo "========================================" >> "$log_file"
