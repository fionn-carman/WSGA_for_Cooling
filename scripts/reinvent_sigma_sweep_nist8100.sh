...
# ============================================================
# REINVENT Sigma Sweep (NIST 8100 + Diversity, nocost only)
# ============================================================
#
# Sweeps sigma = {1.0, 2.0, 4.0} at the nocost MolPrice level
# across all 4 categories with 5 seeds each.
#
# Sweep grid: 3 sigmas x 4 categories x 5 seeds = 60 jobs
#
# Sigma values:
...
#
# Index decoding (60 jobs):
#   sigma_idx    = N / (n_category * n_seed)   # 0-2
...
# Nocost only — no MolPrice penalty
MOLPRICE_SOFT=0.0
MOLPRICE_HARD=0.0
LEVEL="nocost"
