#!/bin/bash
#PBS -N compute_desc_constraints
...
# ============================================================
# Precompute Mordred + RDKit descriptors for constraint datasets
# ============================================================
#
# Single job — computes descriptors for all unique SMILES across
# DC, MP, BP, FP datasets (~5000 molecules).
#
# Usage:
#   qsub compute_constraint_descriptors.sh
# ============================================================
...
exec > "$LOGFILE" 2>&1
echo "=== Compute constraint descriptors (Mordred + RDKit) ==="
